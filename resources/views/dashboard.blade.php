  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card-box widget-box-two widget-two-custom">
            ...
            <div class="wigdet-two-content">
              ...
              <h2 class="font-600"><span>$65,841</span></h2>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card-box widget-box-two widget-two-custom">
            ...
            <div class="wigdet-two-content">
              <p class="m-0 text-uppercase font-bold font-secondary text-overflow" title="Statistics">Customers</p>
              <h2 class="font-600"><span data-plugin="counterup">296</span></h2>
              <p class="m-0">6/27/2017</p>
            </div>
          </div>
        </div><!-- end col -->
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card-box widget-box-two widget-two-custom">
            ...
            <div class="wigdet-two-content">
              <p class="m-0 text-uppercase font-bold font-secondary text-overflow" title="Statistics">Entertainers</p>
              <h2 class="font-600"><span data-plugin="counterup">124</span></h2>
              <p class="m-0">6/27/2017</p>
            </div>
          </div>
        </div><!-- end col -->
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card-box widget-box-two widget-two-custom">
            ...
            <div class="wigdet-two-content">
              <p class="m-0 text-uppercase font-bold font-secondary text-overflow" title="Statistics">Current Dances</p>
              <h2 class="font-600"><span data-plugin="counterup">18</span></h2>
              <p class="m-0">Active Dances</p>
            </div>
          </div>
        </div><!-- end col -->
      ...
      <div class="row">
                  ...
                  <tr>
                    <th>
                      <div class="btn-group dropdown">
                        <button type="button" class="btn btn-secondary btn-xs dropdown-toggle waves-effect waves-light"
        ...
        <div class="col-lg-3">
          <div class="card-box">
            <h4 class="header-title m-t-0 m-b-30">Checked In Staff</h4>
